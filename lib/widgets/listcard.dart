...
import 'package:feedcards/widgets/card.dart'; // Importa el widget personalizado `card` que se utiliza para mostrar cada publicación
import 'package:flutter/material.dart'; // Importa los widgets de Flutter para construir la interfaz
